...
public abstract class Sprite {
    ...
    /**
     * X position in pixels of the upper left corner of the sprite in
     * SpriteSheet.
     */
    private int x;

    /**
     * Y position in pixels of the upper left corner of the sprite in the
     * SpriteSheet.
     */
    private int y;
     ...
     * @param xPos - x position of the Sprite tile in {@link SpriteSheet}
     *            (0-based)
